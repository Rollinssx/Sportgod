var Pixio = function() {
    ...
    var i = function() {
      ...
      , a = function() {
        if (e <= 991) {
            ...
            function i(e, t) {
                ...
                t.parent().hasClass("open") ? t.parent().removeClass("open") : (t.hasClass("sub-menu") || t.parent().parent().find("li").removeClass("open"),
                t.parent().addClass("open"))
            }
            jQuery(".navbar-nav > li > a, .sub-menu > li > a, .navbar-nav > li > a > i, .sub-menu > li > a > i").unbind().on({
                click: function(e) {
                    t = jQuery(this),
                    i(e, t)
                },
      ...
      , s = function() {
        ...
        jQuery("#lightgallery2").length > 0 && lightGallery(document.getElementById("lightgallery2"), {
            plugins: [lgThumbnail, lgZoom],
            selector: ".lg-item",
            thumbnail: !0,
            exThumbImage: "data-src"
      ...
      , d = function() {
        ...
        jQuery(".filters").length > 0 && (jQuery(".filters li:first").addClass("active"),
      ...
      , u = function() {
        if (jQuery("#Isotope, .isotope").length > 0) {
            var e = jQuery("#Isotope, .isotope");
            e.isotope({
                itemSelector: ".card-container",
                layoutMode: "fitRows"
            })
        }
        jQuery(".filter-isotope").length > 0 && (jQuery(".filter-isotope li:first").addClass("active"),
    ...
    var v = function(e) {
      ...
      , k = function() {
        if ($("#slider-tooltips").length > 0) {
            var e = document.getElementById("slider-tooltips")
              , t = {
                from: function(e) {
                    return Number(e)
                },
            ...
            var i = [document.getElementById("slider-margin-value-min"), document.getElementById("slider-margin-value-max")];
            e.noUiSlider.on("update", function(e, t, n) {
                i[0].innerHTML = "Min Price: $" + e[0],
                i[1].innerHTML = "Max Price: $" + e[1]
            })
        }
        if ($("#slider-tooltips2").length > 0) {
            var e = document.getElementById("slider-tooltips2")
              , t = {
                from: function(e) {
                    return Number(e)
                },
            ...
            var i = [document.getElementById("slider-margin-value-min2"), document.getElementById("slider-margin-value-max2")];
            e.noUiSlider.on("update", function(e, t, n) {
                i[0].innerHTML = "Min Price: $" + e[0],
                i[1].innerHTML = "Max Price: $" + e[1]
            })
      ...
      , w = function() {
        $("input[name='demo_vertical2']").length > 0 && jQuery("input[name='demo_vertical2']").TouchSpin({
            verticalbuttons: !0,
            verticalupclass: "fa-solid fa-plus",
            verticaldownclass: "fa-solid fa-minus"
        }),
        $(".quantity-input").length > 0 && jQuery(".quantity-input").TouchSpin({
            verticalbuttons: !0,
            verticalupclass: "fa-solid fa-plus",
            verticaldownclass: "fa-solid fa-minus"
        })
      ...
      , I = function() {
        document.querySelectorAll(".color-filter .form-check-input").forEach(function e(t, i, n) {
            var o = $(t).val();
            $(t).closest(".form-check").find("span").css({
                backgroundColor: o
            })
        })
    }
      , B = function() {
        ...
        setTimeout(function() {
            jQuery(".smart-product-details .dz-content").each(function() {
                var e = Math.ceil(jQuery(this).outerHeight());
                jQuery(this).parent().find(".dz-media img").css("--static-height", e + "px")
            })
        }, 500)
    }
      , M = function() {
      ...
      , q = function() {
        var e = new Date(h).getTime()
          , t = setInterval(function() {
            var i, n, o, a, s, l, r, c, d, u, f;
            i = new Date().getTime(),
            n = e - i,
            ...
            r = 1 == o.toString().length ? "0" + o : o,
            c = 1 == a.toString().length ? "0" + a : a,
            d = 1 == s.toString().length ? "0" + s : s,
            u = 1 == l.toString().length ? "0" + l : l,
            jQuery("#day").text(r),
            jQuery("#hour").text(c),
            jQuery("#min").text(d),
            jQuery("#second").text(u),
            f = 6 * l,
            $(".round").css({
      ...
      , L = function() {
        ...
        $(window).scroll(function() {
            if (e <= 768) {
                ...
                i > t ? $(".extra-nav").addClass("active") : $(".extra-nav").removeClass("active"),
                t = i
            }
        })
    }
      , D = function() {
        ...
        e.on("mousemove", function(e) {
            let t = $(this).offset();
            var i = (e.pageX - t.left) / $(this).width() * 100 <= 100 ? (e.pageX - t.left) / $(this).width() * 100 : 100
              , n = (e.pageY - t.top) / $(this).height() * 100 <= 100 ? (e.pageY - t.top) / $(this).height() * 100 : 100;
            $(this).find("img").css("transform-origin", i + "% " + n + "%")
        }),
        e.on("mouseenter", function(e) {
            let t = $(this).find("img");
            t.css("cursor", "pointer"),
            t.css("transition", "0.1s"),
            t.css("transform", "scale(1.5)"),
            $(this).find(".mfp-link i").css({
                opacity: 1,
                zIndex: 1
            })
        }),
      ...
      , H = function() {
        var e = `<div class="modal fade inquiry-modal style-1" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        "true" != function e(t) {
            ...
            return ""
        }("prevent_subscription") && (jQuery("body").append(e),
        setTimeout(function() {
      ...
      , O = function() {
        $(document).on("click", ".modal-content .btn-close", function() {
            var e, t;
            (e = new Date).setTime(e.getTime() + 18e5),
            t = "expires=" + e.toString(),
            document.cookie = "prevent_subscription=true;" + t + ";path=/"
        })
    }
      , N = function() {
        jQuery(".show-pass").on("click", function() {
            var e = jQuery(this).parent().find(".dz-password");
            "password" == e.attr("type") ? (e.attr("type", "text"),
            jQuery(this).addClass("active")) : (e.attr("type", "password"),
      ...
      , R = function() {
        let e = new Date
          , t = e.getFullYear()
          , i = document.getElementsByClassName("current-year");
        for (let n of i)
            n.innerHTML = t
    }
      , F = function() {
            ...
            window.requestAnimationFrame(function() {
                e.each(function() {
                    var e = $(this)
                      ...
                      , i = e.offset().top
                      , n = e.height()
                      , o = t - i + (.5 * window.innerHeight - .5 * n)
                      , a = e.data("parallax-speed") || .1;
                    e.css({
                        transform: "translate3d(0," + -(o * a) + "px, 0) rotate(" + -(o * a) + "deg)"
                    })
                })
            })
        }),
        jQuery(".bg-parallax").length > 0 && $(window).on("scroll", function() {
            ...
            $(".bg-parallax").css("background-position-y", .02 * e + "px")
        })
    }
      , U = function() {
        jQuery("#tagSlider").length > 0 && $("#tagSlider").grouploop({
            velocity: 1,
            forward: !1,
            pauseOnHover: !0,
            childNode: ".item",
        ...
        jQuery("#tagSlider2").length > 0 && $("#tagSlider2").grouploop({
            velocity: 1,
            forward: !0,
            pauseOnHover: !0,
            childNode: ".item",
      ...
      , X = function() {
        if (jQuery("#Maping").length > 0) {
            ...
            if (i.top >= 0 && i.bottom <= $(window).height()) {
                var n = (i.bottom - $(window).height()) / (i.height - $(window).height()) * 100
                  , o = (n = Math.min(100, Math.max(0, n))).toFixed() + "%";
                t.css("height", o)
            }
        }
    }
      , Y = function() {
        document.querySelectorAll(".word-rotate").forEach( (e, t) => {
            var i = $(e).text().split("");
            let n = 360 / i.length;
            i.forEach( (t, i) => {
                $(e).closest(".word-rotate-box").append('<span class="text__char" style="--char-rotate :' + i * n + 'deg">' + t + "</span>")
            }
            ),
            $(e).remove()
        }
      ...
      , J = function() {
        ...
        (r => {
            window.onmousemove = e => {
                i = void 0 != e.clientX ? e.clientX : -100,
                n = void 0 != e.clientY ? e.clientY : -100
            }
            ,
            ...
            let d = e => {
                let t = {
                    pointerColor: "#750c7e",
                    ringSize: 15,
                    ringClickSize: (r.ringSize || 15) - 5
                };
                return void 0 == r[e] ? t[e] : r[e]
            }
              , u = () => {
                void 0 != i && (o = c(o, i, .2),
                a = c(a, n, .2),
                document.querySelector(".p-action-click:hover") ? (e.style.borderColor = d("pointerColor"),
                s = !0) : (e.style.borderColor = "white",
                s = !1),
                t.style.borderColor = d("pointerColor"),
                l ? t.style.padding = d("ringClickSize") + "px" : t.style.padding = d("ringSize") + "px",
                e.style.transform = `translate(${i}px, ${n}px)`,
                t.style.transform = `translate(${o - (l ? d("ringClickSize") : d("ringSize"))}px, ${a - (l ? d("ringClickSize") : d("ringSize"))}px)`,
      ...
      , W = function() {
        jQuery("#imagePreview").length > 0 && ($("#imageUpload").on("change", function() {
            !function e(t) {
        ...
        $(".remove-img").on("click", function() {
            ...
            $("#imagePreview").css("background-image", "url(images/no-img-avatar.png)")
        }))
    }
      , Z = function() {
        if (jQuery("#copyButton").length > 0) {
            function e(e) {
                var t, i, n, o = "_hiddenCopyText_", a = "INPUT" === e.tagName || "TEXTAREA" === e.tagName;
                if (a)
                    s = e,
                    t = e.selectionStart,
                    i = e.selectionEnd;
                ...
                return l && "function" == typeof l.focus && l.focus(),
                a ? e.setSelectionRange(t, i) : s.textContent = "",
                n
            }
            $("#copyButton").on("click", function(t) {
                t.preventDefault,
                $("#copyButton").addClass("active").text("Copied"),
                $("#copyTarget").addClass("active"),
                e("#copyTarget")
            }),
            document.getElementById("copyButton").addEventListener("click", function(t) {
                t.preventDefault,
                $("#copyButton").addClass("active").text("Copied"),
                $("#copyTarget").addClass("active"),
                e(document.getElementById("copyTarget"))
            })
        }
    };
    return {
        init: function() {
            ...
            v(h),
            g(),
            jQuery(".modal").on("show.bs.modal", p),
            k(),
            y(),
            C(),
            w(),
