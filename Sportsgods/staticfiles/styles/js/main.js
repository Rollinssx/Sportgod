...
$(document).ready(function () {
    ...
    // Open Side Menu
    $('.sidemenu .open').on('click', function (event) {
        event.preventDefault();  // Prevents the default <a> action
        $('.side-info').addClass('info-open');
        $('.offcanvas-overlay').addClass('overlay-open');
    });

    // Close Side Menu (when clicking close button or outside overlay)
    $('.side-info-close, .offcanvas-overlay').on('click', function () {
        $('.side-info').removeClass('info-open');
        $('.offcanvas-overlay').removeClass('overlay-open');
    });

    // Close Side Menu when clicking anywhere outside it
    $(document).on('click', function (event) {
        if (!$(event.target).closest('.side-info, .sidemenu .open').length) {
            $('.side-info').removeClass('info-open');
            $('.offcanvas-overlay').removeClass('overlay-open');
        }
    });
